...
- Detect follow-up questions and route them directly to the most relevant specialist
...
- Consider keywords and context to identify the specialist domain:
  * Revenue, money, income, pricing, monetization → REVENUE_MODEL_ANALYST
  * UI, UX, design, user experience, interface → UX_UI_SPECIALIST
  * Technical, architecture, code, database, API → TECHNICAL_ARCHITECT
  * Business, domain, market, industry, compliance → DOMAIN_EXPERT
...
Please analyze the current state and decide which agent should act next. If this is a follow-up question, route directly to the most relevant specialist."""
